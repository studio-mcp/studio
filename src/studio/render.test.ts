...
describe("BuildCommandArgs", () => {
  ...
  it("preserves shell safety with complex template values", () => {
...
describe("EnhancedTemplateProcessing", () => {
...
describe("BuildCommandArgsWithBooleanFlags", () => {
...
describe("BuildCommandArgsTokenized", () => {
  it("builds simple command without templates", () => {
    const bp = fromArgs(["echo", "hello", "world"]);
    const args = buildCommandArgs(bp, {});
    expect(args).toEqual(["echo", "hello", "world"]);
...
describe("BuildCommandArgs_SingleBrace", () => {
